...
const Footer = () => {
  ...
  return (
      <div>
        <div className="w-full bg-slate-800 text-white flex flex-col space-x-3 align-middle justify-center items-center ml-auto mr-auto pl-6 pr-4 pt-6 pb-4 lg:pt-2 lg:flex-row">
        <div className="flex justify-center lg:hidden space-x-6">
         ...
         <p className="text-center flex lg:text-center mb-2 mt-3 lg:mb-2">Developed by <span className='mr-2 ml-2 text-fuchsia-300'> Ayelen Llampa</span></p>
